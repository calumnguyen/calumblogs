...
// Default menus - only View and Help
const DEFAULT_MENUS: MenuConfig[] = [
  {
    label: 'View',
    items: [
      { label: 'Education Experiences', action: 'view-education' },
      { label: 'Professional Experiences', action: 'view-professional' },
      { label: 'Web Dev Projects', action: 'view-webdev' },
      { label: 'Blog Posts', action: 'view-blog' },
    ],
  },
  {
    label: 'Help',
    items: [
      { label: 'Contact Calum', action: 'contact-calum' },
    ],
  },
];
